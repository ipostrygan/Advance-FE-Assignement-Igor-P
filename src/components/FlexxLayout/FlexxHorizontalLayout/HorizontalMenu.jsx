// Do not remove this following 'use client' else SubMenu rendered in FlexxVerticalLayout menu on smaller screen will not work.
'use client';
    ...
    >
      ...
      >
        ...
        >
          ...
          <SubMenu
            label={dictionary['navigation'].plan}
            icon={<i className='ri-file-list-2-line' />}
          >
            <MenuItem href={`/apps/invoice/list`}>
              {dictionary['navigation'].list}
            </MenuItem>
            <MenuItem href={`/apps/invoice/preview/${id || '4987'}`}>
              {dictionary['navigation'].preview}
            </MenuItem>
            <MenuItem href={`/apps/invoice/edit/${id || '4987'}`}>
              {dictionary['navigation'].edit}
            </MenuItem>
            <MenuItem href={`/apps/invoice/add`}>
          ...
          >
            <MenuItem href={`/apps/user/list`}>
              {dictionary['navigation'].list}
            </MenuItem>
            <MenuItem href={`/apps/user/view`}>
          ...
          >
            <MenuItem href={`/apps/roles`}>
              {dictionary['navigation'].roles}
            </MenuItem>
            <MenuItem href={`/apps/permissions`}>
        ...
        >
          ...
          >
            <MenuItem href={`/pages/wizard-examples/checkout`}>
          ...
          <MenuItem
            href={`/icons-test`}
            icon={<i className='ri-remixicon-line' />}
          >
            Icons Test
          </MenuItem>
        </SubMenu>
