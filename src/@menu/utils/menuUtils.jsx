...
/*
 * Reason behind mapping the children of the FlexxHorizontalLayout-menu component to the FlexxVerticalLayout-menu component:
 * The Horizontal menu components will not work inside of Vertical menu on small screens.
 * So, we have to map the children of the FlexxHorizontalLayout-menu components to the FlexxVerticalLayout-menu components.
        ...
        case HorizontalMenu:
          return (
            <VerticalMenu {...verticalMenuProps}>
              {mapHorizontalToVerticalMenu(child.props.children)}
            </VerticalMenu>
          );
        default:
          return child;
